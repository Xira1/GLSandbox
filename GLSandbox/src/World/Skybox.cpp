...
void CubemapTexture::Create(std::vector<std::string>& textures) {
...
void Skybox::RenderSkyBox(OpenGLShader& shader, OpenGLFrameBuffer& fbo) {
	fbo.Bind();
	fbo.SetViewport();
	...
	shader.SetFloat("darknessFactor", 1.0f);
