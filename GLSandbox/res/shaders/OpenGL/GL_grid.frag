...
void main() {
    ...
    float lineXLarge = smoothstep(0.015 - derivLarge.x, 0.015 + derivLarge.x, gridLarge.x);
    float lineYLarge = smoothstep(0.015 - derivLarge.y, 0.015 + derivLarge.y, gridLarge.y);
