...
OpenGLFrameBuffer::OpenGLFrameBuffer(const char* name, const glm::ivec2& resolution) {
...
void OpenGLFrameBuffer::Create(const char* name, const glm::ivec2& resolution) {
	Create(name, resolution.x, resolution.y);
}
...
void OpenGLFrameBuffer::CreateAttachment(const char* name, GLenum internalFormat, GLenum minFilter, GLenum magFilter, GLenum wrapFilter, bool allocateMips) {
    ...
    colorAttachment.format = OpenGLUtils::GLInternalFormatToGLFormat(internalFormat);
    colorAttachment.type = OpenGLUtils::GLInternalFormatToGLType(internalFormat);
