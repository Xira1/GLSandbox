...
#include "API/OpenGL/GLUtil/GL_utils.hpp"
...
namespace TextureTools {
	bool m_InitializeCMPFrameWork = false;
    ...
    TextureData LoadUncompressedTextureData(const std::string& filepath) {
        ...
        textureData.m_format = OpenGLUtils::GetFormatFromChannelCount(textureData.m_channelCount);
        textureData.m_internalFormat = OpenGLUtils::GetInternalFormatFromChannelCount(textureData.m_channelCount);
        return textureData;
    }
